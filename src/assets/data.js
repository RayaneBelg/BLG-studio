...
export const SLIDE = [
    {id:1 ,img : gmt , title : 'GMT' , desc : 'fashion designer brand' , service : "E-commerce boutique", stack : SiWoocommerce  , phone :gmtphone , slide : [ gmtphone , gmttablet , gmtdesktopp] , extend : "Créateur de mode , un style hautement graphique..." },// Red
    {id:2,img :climax , title : 'CLIMAX FIGHT A.' , desc : "Club de passionés d'arts martiaux" , service : "E-commerce boutique", stack : FaReact , laptop : climaxlaptop , phone : phoneclimax , slide : [ climaxlaptop]}, // Green
