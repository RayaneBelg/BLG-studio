        ...
        {selected && (
          ...
          >
            ...
            <motion.div
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0.8 }}
              className="bg-lightBg dark:bg-DarkBg  overflow-y-auto shadow-xl text-center opacity-100 shadow-lightText h-[70vh] md:h-[60vh] w-[85%] md:w-[70%] flex flex-col items-center scrollbar scrollbar-thumb-rose md:scrollbar-track-slate-700"
            ...
            >
              ...
              {/* Slider Section */}
              <div className="flex md:flex-row flex-col justify-between  md:items-center  w-[95%] md:h-[90%]  border">
                {/* Slider */}
                <div className="flex flex-col justify-center items-center md:w-[50%] h-[min-content] relative border md:h-[100%]">
                  <BsChevronLeft
                    size={30}
                ...
                {/* Info Section */}
                <div className="flex flex-col justify-center md:gap-5 md:w-[50%] items-start border md:h-[100%]">
              ...
              <button
                onClick={closeModal}
                className=" absolute right-2 mt-4 text-3xl font-extrabold  text-rose p-2 top-2 "
              >
                X
              </button>
            </motion.div>
