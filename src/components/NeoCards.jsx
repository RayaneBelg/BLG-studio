...
export default function NeoCards({infos}) {
    ...
    return (
      <motion.div
        ...
        className={`${ infos.id  === 1 || infos.id  === 4 || infos.id  === 5 ?   'md:col-span-2 ' : 'col-span-1'}  text-center shadow-[5px_5px_10px_#717575,-5px_-5px_10px_#ffffff] dark:shadow-[5px_5px_10px_#1c232e,-5px_-5px_10px_#4a5f7c] p-2 flex flex-col bg-lightBg dark:bg-DarkBg text-lightText dark:text-darkText font-teko rounded-sm `}
      >
        {/* Card Content */}
